...
wk.register({
    ["="] = {
        ...
        F = { "<cmd>Telescope find_files cwd=", "Find File at" },
        g = { "<cmd>Telescope live grep<CR>", "Live Grep" },
        G = { "<cmd>Telescope live grep cwd=", "Live Grep at" },
    ...
    ["z"] = {
        name = "cscope",
        s = {":cs find s <C-R>=expand('<cword>')<CR><CR>", "References"},
        g = {":cs find g <C-R>=expand('<cword>')<CR><CR>", "Definition"},
        ...
        m = {":ZenMode:set scroll=1", "Zen Mode"},
        n = {":Twilight", "Twilight"},
    },
    ["m"] = {
        name = "LSP",
