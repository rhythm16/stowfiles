...
wk.register({
    ["="] = {
        ...
        ["="] = { "<cmd>Trouble diagnostics toggle<CR>", "Trouble" },
        y = { "<cmd>Trouble symbols toggle<CR>", "Trouble Symbols" },
        q = { "<cmd>Trouble qflist toggle<CR>", "Trouble Quickfix" },
        l = { "<cmd>Trouble loclist toggle<CR>", "Trouble Location" },
    },
    ["z"] = {
        name = "cscope",
